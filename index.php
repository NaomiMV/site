...
<body>
    ...
    <main>
       <br>
        ...
        <div class="intro"><p>Welkom op het zoetste plekje op het internet.
        in 2016 kwam Naömi op het idee om een website te beginnen over het verkopen van suikerspinmachines.
        het idee werd verzonnen nadat ze op haar 18e verjaardag een suikerspinmachine kreeg en werd ingehuurt om suikerspinnen te verkopen op haar feestje. Hier komt OhSugar vandaan.
        op OhSugar kan je de machine vinden om je eigen suikerspinnen bedrijf te beginnen.
         Veel plezier.
          </p></div>

        <div id="suikerspin"> <img src="Images/Cotton-Candy.png" alt="Cotton Candy" alt= "suikerspin" /></div>
...
div.intro{
    ...
    left: 790px;
    width: 300px;
    border: 5px solid rgb(255, 229, 255);
