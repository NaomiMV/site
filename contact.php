...
$voornaam = $_POST['firstname']; //get input text
$achternaam = $_POST['lastname']; //get input text
$mail = $_POST['email']; //get input text

echo "Beste $voornaam $achternaam<br>";
echo "U heeft ons een berichtje gestuurd en wij zullen naar het email adres $mail een mailtje sturen zodra wij de kans hebben <br>";
